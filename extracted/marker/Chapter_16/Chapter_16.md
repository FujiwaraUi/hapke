# <span id="page-0-0"></span>Simultaneous transport of energy by radiation and thermal conduction
...
where *visual* λ denotes the visual wavelength region where *I*<sup>λ</sup> is appreciable, and similarly for *thermal* λ. Define the visual value of any parameter *X*<sup>λ</sup> by

$$X_V(z) = \int_{visual \,\lambda} X_{\lambda}(z) I_{\lambda}(z, \Omega, t) d\lambda / I_V(z, \Omega, t).$$

Assuming that the spectrum of *I*<sup>λ</sup> is similar to that of *J*<sup>λ</sup> we can calculate *XV* to a good approximation by
...
where )*<sup>T</sup>* is the volume particle emissivity and <sup>γ</sup>*<sup>T</sup>* <sup>=</sup> <sup>√</sup>1!*w<sup>T</sup>* . Then the separated equations become
...
respectively in the upward and downward directions, and let *I*1*<sup>T</sup>* and *I*2*<sup>T</sup>* be similar thermal radiances,
...
After making these substitutions and combining the resulting expressions (see Chapter [8](#page-0-0) for details), the equations for the visual radiance become
...
with the condition at the surface that *I*2*<sup>V</sup> (*0*,t)* = 0, which requires
